...
public class StaticEx {
	...
	public static int refCount; //클래수 변수(인스턴스화하지 않아도 접근 가능)
	public static String classVar;  //클래스 변수
	// static 메서드 안쪽에서는 static 멤버만 접근가능
	...
	static {
		// 클래스 변수의 초기화를 담당
		// 해당 클래스가 최초 사용될 때 한번 실행되고 
		// 이후 프로그램 종료시 해제된다(=실행안된다)
		refCount = 0;
		classVar = "Static Member";
		System.out.println("----- Static Block");
//		instanceVar = "Instance Var";  ->error
		//static 영역에서는 static 만 접근가능
